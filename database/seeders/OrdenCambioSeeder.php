...
class OrdenCambioSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $puntaje1 ->notificacionDeConformidad_id =1;
        $puntaje1->save();
        ...
        $puntaje2 ->notificacionDeConformidad_id =1;
        $puntaje2->save();
        ...
        $puntaje3 ->notificacionDeConformidad_id =1;
        $puntaje3->save();
        ...
        $puntaje4 ->notificacionDeConformidad_id =1;
        $puntaje4->save();
        ...
        $puntaje5 ->notificacionDeConformidad_id =1;
        $puntaje5->save();
        ...
        $puntaje6 ->notificacionDeConformidad_id =1;
        $puntaje6->save();
        ...
        $puntaje7 ->notificacionDeConformidad_id =1;
        $puntaje7->save();
