...
Cumplimiento de especificaciones del proponente & 15 puntos & 9 \\ \hline
Claridad en la organización de la empresa proponente & 10 puntos & 9 \\ \hline
...
Precio total & 15 puntos & 15 \\ \hline
...
TIS después de revisar la propuesta de su empresa \textbf{SoftVision}, tiene las siguientes observaciones:
	...
	\begin{enumerate}
\item Boleta de garantia, sección 1.16., Tis hace saber que la observacion se encuentra mal
\item Carta de presentacion, sección 1.18., Tis hace saber que la observacion se encuentra mal 2
\item Parte B, sección 1.19., Tis hace saber que la observacion se encuentra mal 3
	\end{enumerate}
Esta adenda de corrección debe ser entregada hasta el \textbf{2021-11-19 a horas 9:30} , en \textbf{ edificio nuevo umss, aula 691a}.
